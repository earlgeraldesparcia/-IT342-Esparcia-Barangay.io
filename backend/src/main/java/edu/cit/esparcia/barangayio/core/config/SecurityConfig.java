package edu.cit.esparcia.barangayio.core.config;
...
public class SecurityConfig {
     ...
     * - Automatically generates a 16-byte random salt
     * - Default strength is 10 (can be increased for more security)
     * - Produces a 60-character string (hash + salt)
     */
    @Bean
