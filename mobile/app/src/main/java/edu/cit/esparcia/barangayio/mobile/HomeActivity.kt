...
class HomeActivity : AppCompatActivity() {
    ...
    private fun updateUpcomingUI(upcoming: edu.cit.esparcia.barangayio.mobile.model.Appointment?) {
    ...
    private fun updateCompletedUI(completed: edu.cit.esparcia.barangayio.mobile.model.Appointment?) {
